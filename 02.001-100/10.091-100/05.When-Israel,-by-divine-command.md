---
title: |
    095 When Israel, by divine command - Hymns for the Poor of the Flock
metadata:
    description: |
        Hymns for the Poor of the Flock 095. When Israel, by divine command. When Israel, by divine command, The pathless desert trod, They found, throughout the barren land,  A sure resource in God. 
    keywords:  |
        Hymns for the Poor of the Flock, adventhymnals, advent hymnals, When Israel, by divine command, When Israel, by divine command,, 
    author: Brian Onang'o
---

#### Advent Hymnals
## 095. When Israel, by divine command
